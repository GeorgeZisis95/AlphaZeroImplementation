...
class TicTacToe:
    ...
    def get_valid_moves(self, state):
        # This is the form: [1 1 1 1 1 1 1 1 1] 
        return (state.reshape(-1) == 0).astype(np.uint8)
    
    def get_valid_moves_indices(self, state):
        # This is the form [0 1 2 3 4 5 6 7 8]
    ...
    def minimax(self, board, depth, is_maximizing, alpha=-np.inf, beta=np.inf):
        ...
        if np.sum(self.get_valid_moves(board)) == 0:
            return 0, None
